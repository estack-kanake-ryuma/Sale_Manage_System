...
$lang['date']				= "%s 欄には、存在しない日付は入力できません。";
$lang['half_str']			= "%s 欄には、半角文字以外は入力できません。";
$lang['time']				= "%s 欄には、存在しない時間は入力できません。";
$lang['money']				= "%s 欄には、正確な金額を入力ください。";
$lang['yearmonth']          = "%s 欄には、正確な年月を入力ください。";
$lang['report_no']          = "%s 欄には、正確な報告書Noを入力ください。";
$lang['rec_money']			= "%s 欄には、正確な金額を入力ください。-の金額及び0円は入力できません。";
$lang['post_no']			= "いずれかを入力した場合は必ずすべて入力してください。";
$lang['tel_no']             = "いずれかを入力した場合は必ずすべて入力してください。";
