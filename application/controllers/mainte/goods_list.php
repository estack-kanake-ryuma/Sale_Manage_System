 ...
 * @property goods_mdl $goods_mdl
 */
class Goods_list extends MY_Controller {
	...
	public function index()
	{
                ...
                // 検索条件を設定
                $condition = $this->goods_mdl->create_search_condition();
		...
		// 検索条件の入力値
		$data['search'] = $this->goods_mdl->get_input_condition();
                
                // セッションを設定
                $this->goods_mdl->set_list_session();

		$this->load->view('mainte/goods_list', $data);
	...
	public function delete()
	{
            ...
            // 削除処理実行
            $bRes = $this->goods_mdl->delete_data($id);
	 ...
	 */
        private function _get_disp_list_data($condition) 
        {
            ...
            // 一覧を取得
            $list = $this->goods_mdl->get_list_data($condition, $start);
	 ...
	 */
        private function _get_total_cnt($condition) {           
            ...
            // 件数取得
            return $this->goods_mdl->get_total_cnt($condition);
